namespace LiveCode
{
    ...
    {
        private static readonly Dictionary<int, string> baseValues = new()
        {
            { 1000, "M" },
            { 900, "CM" },
            { 500, "D" },
        ...
        public static string NumberToRomanNumeral(string? numberInput)
        {
        ...
        public static int RomanNumeralToNumber(string? romanInput)
        {
            if (romanInput is null) return 0;
